...
%     impactframelist=[149,149,147,162,165,162,181,190,177,213,208,199];
folders_b=dir([[home,'/bottom/'],'N7*']);
folders_f=dir([[home,'/front/'],'N7*']);
nfolders=length(folders_b);
H_setmm=explog{:,'H_mm'};
Pmbar=explog{:,'P_mbar'};
...
for i=1:nfolders
    ...
    imfiles_b=getImfiles([folders_b(i).folder,'/',folders_b(i).name]);
